 ...
 */
export async function createAnnouncement(data: { title: string; content: string; isUrgent: boolean }) {
    try {
 ...
 */
export async function createEvent(data: { title: string; description: string; date: Date; time: string; location: string }) {
    try {
