...
import { Trash2, Plus, Calendar as CalendarIcon, MapPin, Clock, ImageIcon } from 'lucide-react';
...
export default function AdminEvents() {
    ...
    const handleCreate = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const res = await createEvent({ title, description, date, time, location, coverImage });
        if (res.success) {
        ...
        <div className="space-y-6">
            ...
            {showForm && (
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 mb-8 animate-fade-in">
                    <h2 className="text-xl font-bold mb-6">Créer un Événement</h2>
                    <form onSubmit={handleCreate} className="space-y-5">
                        ...
                        <ImageUploader
                            ...
                            hint="Image principale affichée sur la carte événement — JPG, PNG, WebP, 5 Mo max"
                        />
                        ...
                        <div className="flex gap-4 pt-2">
                            ...
                            <button type="submit" disabled={submitting}
                                className="px-4 py-2 bg-[var(--color-primary)] text-white rounded-md hover:bg-[var(--color-primary-hover)] disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2">
